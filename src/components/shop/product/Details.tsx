  ...
  return (
    ...
    >
      <div className="flex flex-col mb-6 sm:mb-7 lg:mb-5">
        <h1
          className="text-[24px] sm:text-[30px] lg:text-[28px] font-bold tracking-tighter leading-tight text-black mb-4 uppercase
              ...
              return (
                <button
                  ...
                  className={classNames(
                    "relative flex items-center justify-between px-3 py-2.5 border text-[11px] sm:text-[22px] lg:text-[11px] transition-all duration-300 uppercase tracking-tight font-bold text-left",
                    isActive
      ...
      {scales.length > 0 && (
        <div className="mb-8 sm:mb-9 lg:mb-7">
          <p className="text-[11px] sm:text-[22px] lg:text-[10px] font-black uppercase tracking-[1.8px] mb-4 text-black">
            Escala disponible
          </p>

          {activeScaleDescription && (
            <div className="text-[12px] sm:text-[20px] lg:text-[12px] italic text-zinc-700 leading-relaxed mb-5 whitespace-pre-line">
              {activeScaleDescription}
            </div>
          )}
            ...
            {scales.map((scale, index) => {
              ...
              return (
                <button
                  ...
                  className={classNames(
                    "min-w-[44px] sm:min-w-[42px] lg:min-w-[46px] px-2.5 py-2.5 border text-[10px] sm:text-[20px] lg:text-[10px] font-bold uppercase leading-none transition-all duration-300",
                    !scale?.disponible
     ...
     <div className="flex flex-col gap-2 mb-5 sm:mb-6 lg:mb-6">
        <button
          ...
          className={classNames(
            "w-full py-3.5 lg:py-3 font-bold uppercase text-[10px] sm:text-[22px] lg:text-[10px] tracking-[2px] border transition-colors",
            isFavorite
      ...
      <div className="border-t border-zinc-200 mt-4 pt-3">
        {meta?.aspectos_variables ? (
          <div className="mb-5 rounded-sm border-l-4 border-red-500 bg-red-50 px-3 py-3.5 shadow-sm">
            <div className="text-[12px] sm:text-[20px] lg:text-[14px] italic leading-relaxed tracking-tight text-black">
        ...
        <div className="text-black font-sans italic text-[12px] sm:text-[20px] lg:text-[13px] leading-relaxed tracking-tight whitespace-pre-line">
          {meta?.description || meta?.descripcion || "Sin descripción por el momento."}
        </div>

        {meta?.disclaimer ? (
          <div className="text-black/60 font-sans italic text-[10px] sm:text-[20px] lg:text-[10px] leading-relaxed tracking-tight whitespace-pre-line mt-5">
            {meta.disclaimer}
          </div>
        ) : null}
      </div>
