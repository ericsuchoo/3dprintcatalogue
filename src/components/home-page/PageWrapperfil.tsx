      ...
      <InnerPageWrapper>
        ...
        <div className="pt-36 sm:pt-32 md:pt-24 bg-[#0a0a0a] min-h-screen">
          ...
          <div className="container pb-5">
            ...
            <div className="mt-3 mb-7 flex flex-col gap-3 md:flex-row md:items-start md:justify-between">

              <div className="pr-0 md:pr-6">

                <h1 className="text-[30px] sm:text-4xl md:text-4xl leading-[0.95] font-black uppercase italic text-white tracking-tight">
              ...
              <div className="w-full md:w-auto mt-4 sm:mt-5 md:mt-0 flex flex-wrap items-center gap-3 justify-start md:justify-end">
