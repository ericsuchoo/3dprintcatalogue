        ...
        {data.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/35 to-transparent pointer-events-none transition-all duration-500" />
              ...
              <div className="relative z-20 w-full transition-all duration-500 group-hover:translate-y-[-6px]">
                ...
                <div className="text-[9px] sm:text-[10px] uppercase opacity-75 font-bold text-zinc-300 mt-1">
                ...
                <div className="mt-3 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-2 group-hover:translate-y-0">
                  <span className="inline-flex items-center justify-center px-3 py-2 rounded-full bg-[#00eeff] text-black text-[9px] sm:text-[10px] font-black uppercase tracking-[0.18em] shadow-[0_0_20px_rgba(0,238,255,0.32)]">
                    Ver modelos
                  </span>
                </div>
              </div>
