...
export const HomeCategories: React.FC<Props> = ({ data, ctaTheme, bcms }) => {
  return (
    <section>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 bg-black">
        {data.map((item, index) => {
          const card = item;
          ...
          return (
            <div
              key={index}
              className="group relative aspect-square flex items-end p-10 overflow-hidden bg-black"
            >
